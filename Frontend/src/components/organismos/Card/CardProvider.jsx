...
export const CardProvider = ({name, departament,email, phone, date,address,image}) => {
  return (
    <Container>
      ...
      <PartDown>
        ...
        <Contact><CiCalendarDate  className='iconDown'/>{date}</Contact>
        <Contact><FaRegAddressCard   className='iconDown'/>{address}</Contact>
