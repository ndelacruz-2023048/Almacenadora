    ...
    <Container>
          <Section>
            <Header>
              ...
              <Close>
                <Icon onClick={setIsOutProductFormOpen}  icon="si:close-fill" className='iconClose'/>
              </Close>
            </Header>
            <Form onSubmit={handleSubmit(handleSubmitProductForm)}>  
              ...
              <ContainerFormField>
                <FullWidthInput>
                  <TextField disabled={true} id="outlined-basic"  value="Salida"  variant="outlined" className='inputFullWidth'
                ...
                <FormField>
                  ...
                  <FullWidthInput>
                    <TextField disabled={true} id="outlined-basic" value="Nueva salida de producto" variant="outlined" className='inputFullWidth'
